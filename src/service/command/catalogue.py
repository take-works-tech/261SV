...
PARAMETERS: dict[str, tuple[frozenset[str], frozenset[str]]] = {
    ...
    "view.get": (frozenset(['viewId']), frozenset(['viewId'])),
    ...
    "view.render": (frozenset(['camera', 'cameraPath', 'format', 'height', 'legend', 'viewId', 'width']), frozenset(['format', 'height', 'viewId', 'width'])),
    ...
    "system.log": (frozenset(['level', 'limit', 'since']), frozenset([])),
...
RESULT_FIELDS: dict[str, tuple[frozenset[str], frozenset[str]]] = {
    ...
    "dataset.inspect": (frozenset(['exists', 'format', 'gaps', 'modified', 'refusal', 'sizeBytes', 'supportLevel']), frozenset(['exists', 'format', 'gaps', 'sizeBytes', 'supportLevel'])),
    ...
    "view.get": (frozenset(['definition', 'id', 'revision']), frozenset(['definition', 'id', 'revision'])),
    ...
    "view.render": (frozenset(['cameraPath', 'handle', 'reduced', 'resultPosition']), frozenset(['handle', 'resultPosition'])),
    ...
    "system.log": (frozenset(['entries', 'files', 'logDirectory', 'omitted', 'retainDays', 'source', 'unreadable']), frozenset(['entries', 'files', 'logDirectory', 'omitted', 'retainDays', 'source', 'unreadable'])),
    ...
    "pipeline.run": (frozenset(['failedCases', 'finished', 'resolvedCases', 'results', 'runId', 'started', 'stoppedAt', 'written']), frozenset(['failedCases', 'resolvedCases', 'results', 'runId', 'written'])),
