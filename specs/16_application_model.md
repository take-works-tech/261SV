...
| スタイル | style @Asset; palette chosen for discriminability; background; **the defaults every series follows unless it overrides them** - line width in px and marker shape, in the same vocabulary the series row uses; typography | `Graph.style` | - |
